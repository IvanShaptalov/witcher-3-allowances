...
urlpatterns = [
    ...
    path('accounts/regisrer/done/', RegisterDoneView.as_view(), name='register_done'),
    ...
    path('accounts/profile/change/', ChangeUserInfoView.as_view(),
         name='profile_change'),
    path('accounts/profile/password/change', BbPasswordChangeView.as_view(),
    ...
    path('accounts/reset/done',
         PasswordResetCompleteView.as_view(template_name='registration/password_reset_complete.html'), name='password_reset_complete')
]
