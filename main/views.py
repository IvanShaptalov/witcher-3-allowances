...
def index(request):
    ...
    context = {'bbs': bbs}
    for bb in bbs:
        print(bb.pk, bb.rubric, bb.rubric.pk)
...
# all form to edit user profile
class ChangeUserInfoView(SuccessMessageMixin, LoginRequiredMixin, UpdateView):
    """SuccessMessageMixin - Alert messages
       Login - to login
       UpdateView - Update model"""
    # model to update
    model = AdvUser
    # add html page to view
    template_name = 'main/change_user_info.html'
    # add skeleton form
    form_class = ChangeUserInfoForm
    # redirect after edition
    success_url = reverse_lazy('main:profile')
    # info message after edition
